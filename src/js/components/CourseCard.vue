<template>
    <div  class="w-30 mx-auto pb-3 xs:mx-0 card xs:my-3 h-100 relative flex flex-wrap md:block border-1 border-solid  rounded-lg" v-bind:class="[borderColor]">
                    ...
                    <div class="w-70 md:w-100 font-primary my-2 pr-2">
                        ...
                        <p class="mt-2 mb-0 text-sm font-secondary">
                           <slot name="subtitle"></slot>
                        </p>
                        <p v-if="!showMore" @click="showMore = !showMore" class="text-xs text-blue font-bold font-primary my-0 text-right mr-3 cursor-pointer">Read More</p>
                    </div>
                    <div v-show="showMore" class="w-100 px-2">
                            <p class="text-sm font-secondary mt-0 align-items-center">
                                <slot></slot>
                            </p>
                            ...
                            <a target="_blank" :href=" preRegister ? 'https://forms.gle/BYgx1miPYxUGc5qW8' : 'https://forms.gle/K3xB51gE39Ymqkco7'" class="my-2 text-sm font-bold text-blue"> {{preRegister ? 'Pre-register' : 'Register Now'}} </a>
