...
<nav class="z-9999 transition-500ms w-100 text-black  bg-transparent m-0 t-0 l-0 r-0">
        <div class="w-85  flex mx-auto py-4 mx-0">
            <ul class="w-50 lg:w-40 list mx-0 px-0 ">
                <li class="sm:w-40 m-0 px-0">
                    <a href="" class="xl:text-3xl text-2xl  font-primary"><img width="50" src="<?php echo get_template_directory_uri(); ?>/img/logo.png"
                            class=""> 
                                <span class="xs:hidden"> Open Coding School</span>
                            </a>
                </li>
            </ul>
