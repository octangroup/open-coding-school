        ...
        <div class=" w-85  mx-auto card h-100 m-0 p-0 bg-primary flex rounded-lg"
            ...
            <div class="flex xs:block relative w-90 text-white mx-auto">
                <div class="w-50 md:w-100 xs:w-100 my-5">
                    ...
                    <div class=" pt-3">
                        <a href="#courses"><button class="btn btn-accent text-black font-bold  transition-250ms rounded-lg  border-1 mx-0">
                            Learn More
</button></a>
                    </div>
            ...
            <div class="flex flex-wrap xs:block">
                ...
                <course-card border-color="border-green-light" icon-color="bg-green-lightest" icon-url="<?php echo get_template_directory_uri(); ?>/img/machine-learning (1).png">
                    ...
                    Learn to build great interactive websites and web
                                applications. You will be introduced to HTML, CSS and JavaScript 
                    </template>
                    along with a number of frameworks that help you use
                ...
                <course-card border-color="border-green-light" icon-color="bg-green-lightest" icon-url="<?php echo get_template_directory_uri(); ?>/img/app.png">
                    ...
                    Thereafter you will be introduced
        ...
        <div class="py-4">
            ...
            <course-card border-color="border-orange" icon-color="bg-orange-lighter" icon-url="<?php echo get_template_directory_uri(); ?>/img/machine-learning.png">
                    ...
                    This course brings you from an intermediate understanding
                            of web-development to an advanced level where you can build complex web applications.
                    </template>
                    You will learn new frameworks and best-practices and receive
                ...
                <course-card border-color="border-orange" icon-color="bg-orange-lighter" icon-url="<?php echo get_template_directory_uri(); ?>/img/app2.png">
                    ...
                    We will focus on app development for Android with Java and
                ...
                <course-card :pre-register="true" border-color="border-orange" icon-color="bg-orange-lighter" icon-url="<?php echo get_template_directory_uri(); ?>/img/ruby.png">
                    ...
                    <template v-slot:subtitle>
                    For everyone who wants to work for tech-clients in Europe
                            or build their own scalable tech-product fast, Ruby on Rails is the go-to framework
                    </template>
                    Famous web applications built with Ruby on Rails include
            ...
            <div class="py-4">
                ...
                <course-card :pre-register="true" border-color="border-red-light" icon-color="bg-red-lighter" icon-url="<?php echo get_template_directory_uri(); ?>/img/php.png">
                    ...
                    In this course you will go beyond coding
                                best-practices and focus on questions of software architecture
                    </template>
                    You will reflect on the driving factors of performance
                ...
                <course-card :pre-register="true" border-color="border-red-light" icon-color="bg-red-lighter" icon-url="<?php echo get_template_directory_uri(); ?>/img/we.png" >
                    ...
                    <template v-slot:subtitle>
                    This course will dive into the best-practices of
                                UX/UI design for both web and mobile applications
                    </template>
                    Furthermore you will learn the ins and outs of design
